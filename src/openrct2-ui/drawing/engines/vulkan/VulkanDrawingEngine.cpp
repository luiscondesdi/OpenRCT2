...
constexpr VulkanVersion VULKAN_MINIMUM_REQUIRED_VERSION = { 1, 0 };
...
public:
    ...
    explicit VulkanDrawingEngine(const std::shared_ptr<IUiContext>& uiContext)
    ...
    {
        VulkanVersion requiredVersion = VULKAN_MINIMUM_REQUIRED_VERSION;
    ...
    void PaintWeather() override
    {
        ...
        DrawWeather(_bitsDPI, 0 /*&_weatherDrawer*/);
    }
...
std::unique_ptr<IDrawingEngine> OpenRCT2::Ui::CreateVulkanDrawingEngine(const std::shared_ptr<IUiContext>& uiContext)
{
